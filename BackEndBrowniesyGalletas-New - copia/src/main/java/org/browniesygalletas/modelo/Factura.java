...
public class Factura {
    ...
    public Factura(Cliente nombre, Cliente apellido, Cliente celular, Pedido direccionEntrega, Pedido fechaPedido, Pedido fechaEntregaPedido, double totalFacturacion) {
        this();
        this.nombre = nombre;
